...
def closer_city(lat, lon, city_a, city_b):
    ...
    """
    "*** YOUR CODE HERE ***"
    opt_city = make_city('opt_city', lat, lon)
    a_distance = distance(opt_city, city_a)
    b_distance = distance(opt_city, city_b)
...
def add_trees(t1, t2):
    ...
    """
    "*** YOUR CODE HERE ***"
    now_label = label(t1) + label(t2)
    if is_leaf(t1):
        return tree(now_label, branches(t2))
    if is_leaf(t2):
        return tree(now_label, branches(t1))
