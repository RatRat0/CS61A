class VendingMachine:
    ...
    def vend(self):
        ...
        self.stock, self.funds = self.stock - 1, self.funds - self.price
        if self.funds > 0:
            tmp = self.funds
            self.funds = 0
            return 'Here is your {1} and ${0} change.'.format(tmp, self.product)
        else:
    ...
    def restock(self, morestock):
        self.stock += morestock
...
class Coin:
    ...
    def worth(self):
        ...
        if age > 50:
            append_value = age - 50
        return self.cents + append_value
